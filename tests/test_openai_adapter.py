...
class TestOpenAIAgentAdapter:
    ...
    def test_message_to_intent_exception(self, adapter):
    ...
    def test_openai_hallucination_retry(self, adapter):
    ...
    def test_openai_multimodal_payload(self, adapter):
        mock_choice = MagicMock()
    ...
    def test_openai_adapter_errors(self, adapter):
    ...
    def test_openai_tool_calls_logic(self, adapter):
        # Clarification
        mock_tc = MagicMock()
